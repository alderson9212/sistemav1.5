    ...
    public void llenartb(String descripcion) {
        ...
        try {
            ...
            for (int i = 0; i < listaC.size(); i++) {
                ...
                MunicipioDTO municipio = new MunicipiosController().municipioById(listaC.get(i).getIdmunicipio());
                dtm.setValueAt(municipio.getNombre(),i,2);
            }
            tbcolonias.setModel(dtm);

        } catch (Exception ex) {
            System.out.println("Error al llenar la tabla colonias:"+ex.getMessage());
        }
    }
